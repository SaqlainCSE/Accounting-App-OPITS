...
@section('content')
<div class="container">
    <h2 class="mb-4">সমবায় বাজার খতিয়ান তৈরি করুন</h2>

    @if(session('success'))
        <div class="alert alert-success">{{ session('success') }}</div>
    @endif

    <form action="{{ route('somobayBazarkhatian.store') }}" method="POST">
        @csrf
        ...
        <button type="submit" class="btn btn-primary">সমবায় বাজার খতিয়ান তৈরি করুন</button>
    </form>
