...
@section('content')
<div class="container">
    <h2 class="mb-4">কর্জ খতিয়ান তৈরি করুন</h2>

    @if(session('success'))
        <div class="alert alert-success">{{ session('success') }}</div>
    @endif

    <form action="{{ route('korjokhatian.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="category" class="form-control" required>
                    ...
                    <option value="7">সাপ্তাহিক</option>
                    <option value="8">দৈনিক</option>
                    <option value="3">মাসিক</option>
                    <option value="2">পণ্য</option>
                    <option value="9">বিশেষ</option>
                </select>
            </div>
            {{-- <div class="col-md-6 mb-3">
                <label class="form-label">ক্যাটাগরি:</label>
        ...
        <button type="submit" class="btn btn-primary">কর্জ খতিয়ান তৈরি করুন</button>
    </form>
</div>
@endsection
